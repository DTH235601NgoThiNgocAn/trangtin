...
var uri = 'mongodb://an_dth235601:an123456@ac-dfh57pw-shard-00-02.i8rahxk.mongodb.net:27017/trangtin?ssl=true&authSource=admin';
...
app.use((req, res, next) => {
	...
	res.locals.message = '';
	if (err) res.locals.message =x '<span class="text-danger">' + err + '</span>';
